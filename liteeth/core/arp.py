...
class LiteEthARPTX(Module):
    def __init__(self, mac_address, ip_address, dw=8):
        ...
        self.comb += [
            packetizer.sink.last.eq(counter == counter_size-1),
...
class LiteEthARPTable(Module):
    def __init__(self, clk_freq, max_requests=8):
        ...
        # This is for testing, when the Rx side isn't working
        # One can easily change the IP/MAC address of the network interface
        # to match this or vice versa.
